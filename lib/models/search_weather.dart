...
class SearchWeather {
  ...
  static SearchWeather fromJson(Map<String, dynamic> json) {
    ...
    return SearchWeather(
        ...
        lat: intToDouble(json['coord']['lat']),
        lon: intToDouble(json['coord']['lon']));
  }

  static List<SearchWeather> from7DayJson(json) {
    final weathers = <SearchWeather>[];
